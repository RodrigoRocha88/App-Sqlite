...
class MainActivity : ComponentActivity() {
    ...
    // --- Data class com o novo campo 'category' ---
    data class Note(
        val id: Long? = null,
        val title: String,
        val content: String,
    ...
    class DBHelper(context: Context) :
        SQLiteOpenHelper(context, "app.db", null, 2) { // Atualizado para versão 2
    ...
    private fun NoteItem(
        ...
        Column(
            ...
            Text(text = "Categoria: ${note.category}", style = MaterialTheme.typography.bodySmall)
        }
    }
}
